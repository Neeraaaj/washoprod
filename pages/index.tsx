      ...
      {/* <div className="bg-wrap">
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="service-box layout">
                    ...
                    <div className="img-in" style={{marginTop: '-85px'}}>
                      <a href="#">
                        <img src="https://images.unsplash.com/photo-1543857182-68106299b6b2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=871&q=80" alt=""  style={{borderRadius: '10px 10px 70px 70px'}}/>
                      </a>
                    </div>
                ...
                <div className="col-md-4">
                  <div className="service-box layout">
                    ...
                    <div className="img-in" style={{marginTop: '-85px'}}>
                      <a href="#">
                        <img src="https://img.freepik.com/free-photo/man-washing-his-car-garage_1157-26072.jpg?w=740&t=st=1671029404~exp=1671030004~hmac=69ac65e7a73d3b7612ef0fd652fd6642dfa1c683a05560b9699e1a30d885593c" alt=""  style={{borderRadius: '10px 10px 55px 55px'}}/>
                      </a>
                    </div>
                    <div className="img-icon-box-content">
                ...
                <div className="col-md-4">
                  <div className="service-box layout">
                    ...
                    <div className="img-in" style={{marginTop: '-85px'}}>
                      <a href="#">
                        <img src="https://images.pexels.com/photos/6873088/pexels-photo-6873088.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt=""  style={{borderRadius: '10px 10px 55px 55px'}}/>
                      </a>
                    </div>
                    <div className="img-icon-box-content">
                ...
                <div className="wrapper">
                  ...
                  <span><img src="https://cdn.pixabay.com/photo/2022/06/29/17/53/megaphone-7292261_960_720.png" alt="" style={{width: "95px", left: "6%",marginTop: "-20px",position:"absolute", zIndex: "2", overflowY: "visible"}}/></span>
        ...
        <div className="image-left" id='contact'>
          ...
          <div className="contac_image" style={{marginLeft: "15px", boxShadow: "10px 14px 10px 10px grey"}}>
            <img className="col-lg-0 ml-lg-5" src="https://img.freepik.com/free-vector/organic-flat-customer-support-illustration_23-2148899134.jpg?w=740&t=st=1673180361~exp=1673180961~hmac=ccba984fabdcc7fc179fb85d3b231dd888e5aeb5596d3aaa0d1cffc7f6d947c0" alt="" style={{width: "45%"}} id="contact" />
          </div>  
          <div className="main">
        ...
        <div className="footer">
          ...
          <svg id="wave" style={{ transform:"rotate(0deg)", transition: "0.3s", zIndex: "-1" }} viewBox="0 0 1440 490" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0"><stop stop-color="rgba(0, 73.603, 255, 1)" offset="0%"></stop><stop stop-color="rgba(0, 246.362, 255, 1)" offset="100%"></stop></linearGradient></defs><path style={{ transform:"translate(0, 0px)", opacity:"1", fill:"url(#sw-gradient-0)" }} d="M0,49L120,106.2C240,163,480,278,720,285.8C960,294,1200,196,1440,130.7C1680,65,1920,33,2160,40.8C2400,49,2640,98,2880,163.3C3120,229,3360,310,3600,294C3840,278,4080,163,4320,114.3C4560,65,4800,82,5040,89.8C5280,98,5520,98,5760,98C6000,98,6240,98,6480,130.7C6720,163,6960,229,7200,236.8C7440,245,7680,196,7920,163.3C8160,131,8400,114,8640,147C8880,180,9120,261,9360,245C9600,229,9840,114,10080,106.2C10320,98,10560,196,10800,228.7C11040,261,11280,229,11520,187.8C11760,147,12000,98,12240,81.7C12480,65,12720,82,12960,138.8C13200,196,13440,294,13680,294C13920,294,14160,196,14400,147C14640,98,14880,98,15120,138.8C15360,180,15600,261,15840,310.3C16080,359,16320,376,16560,383.8C16800,392,17040,392,17160,392L17280,392L17280,490L17160,490C17040,490,16800,490,16560,490C16320,490,16080,490,15840,490C15600,490,15360,490,15120,490C14880,490,14640,490,14400,490C14160,490,13920,490,13680,490C13440,490,13200,490,12960,490C12720,490,12480,490,12240,490C12000,490,11760,490,11520,490C11280,490,11040,490,10800,490C10560,490,10320,490,10080,490C9840,490,9600,490,9360,490C9120,490,8880,490,8640,490C8400,490,8160,490,7920,490C7680,490,7440,490,7200,490C6960,490,6720,490,6480,490C6240,490,6000,490,5760,490C5520,490,5280,490,5040,490C4800,490,4560,490,4320,490C4080,490,3840,490,3600,490C3360,490,3120,490,2880,490C2640,490,2400,490,2160,490C1920,490,1680,490,1440,490C1200,490,960,490,720,490C480,490,240,490,120,490L0,490Z"></path></svg>
        </div>
    </div>
  )
}
